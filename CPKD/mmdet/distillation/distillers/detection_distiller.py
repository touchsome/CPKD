    ...
    def __init__(self,
        ...
        if init_student:
            ...
            for name, v in t_checkpoint["state_dict"].items():
                ...
                if name.startswith("backbone.layer3.6"):
                    continue
                elif name.startswith("backbone.layer3.7"):
                    continue
                elif name.startswith("backbone.layer3.8"):
                    continue
                elif name.startswith("backbone.layer3.9"):
                    continue
                elif name.startswith("backbone.layer3.10"):
                    continue
                elif name.startswith("backbone.layer3.11"):
                    continue
                elif name.startswith("backbone.layer3.12"):
                    continue
                elif name.startswith("backbone.layer3.13"):
                    continue
                elif name.startswith("backbone.layer3.14"):
                    continue
                elif name.startswith("backbone.layer3.15"):
                    continue
                elif name.startswith("backbone.layer3.16"):
                    continue
                elif name.startswith("backbone.layer3.17"):
                    continue
                elif name.startswith("backbone.layer3.18"):
                    continue
                elif name.startswith("backbone.layer3.19"):
                    continue
                elif name.startswith("backbone.layer3.20"):
                    continue
                elif name.startswith("backbone.layer3.21"):
                    continue
                elif name.startswith("backbone.layer3.22"):
                    continue
    ...
    def init_weights_teacher(self, path=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        path = 'work_dirs/defeat_r50_gflv1_r101_fpn_coco_1x_new_new/gfl_r101_fpn_mstrain_2x_coco.pth'
